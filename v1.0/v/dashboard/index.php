...
$pagina->cambiarTitulo("Dashboard");
$pagina->SetValidar_Pagina(false);
$pagina->AdicionarScript('dashboard');
$pagina->head();
?>
<div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <img src="../../r/img/Captura.JPG" width="100%">
                                    </div>
                                </div>
                                <!-- /.panel-body -->
                            </div>
