...
$pagina = new Cls_Plantilla(2);
$pagina->AdicionarScript('solicitud');
$pagina->head();
?>
<div class="row">
    ...
    new Cls_Combo(array('tipo'=>'ubicaciones_solicitud',
                        'seleccione'=>1,
                        'class'=>'filtro',
                        'id'=>'cmb_ubicacion',
                        'ope_id'=>4,
    ...
    <div class="col-lg-1 form-group">
        <label>Corte</label>
        <input type="text" class="form-control filtro" value="" filtro="tiempo_corte" id="txt_tiempo_corte" name="txt_tiempo_corte" />
    </div>
    ...
    <div class="col-lg-2 form-group">
        ...
        <input type="date" class="form-control filtro" filtro="fecha_corte" id="txt_fecha_corte" name="txt_fecha_corte" />
    </div>
<?php
